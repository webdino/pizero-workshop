 ...
 * }} DataType2
 * @param {string} v packet
 * @returns {(DataType1 | DataType2)}
 */
Omron2jceBu01.prototype.parse = function(v) {
  ...
  switch(dataType) {
  case 1:
    return this._parseDataType1(packet);
  case 2:
    return this._parseDataType2(packet);
  default:
