...
module.exports = class Machinist extends Record{
  ...
  write(data){
    ...
    if(! this.first_time && this.datas.length < this.multiple){
      console.log(this.datas.length.toString() + ' data stocked');
      return true;
    }
    else{
      this.first_time = false;
      console.log('send ' + this.datas.length.toString() + ' stocked data... ');
      let postDataStr = JSON.stringify(this.format(this.datas));
      this.datas = [];
