...
//const ambient = require('ambient-lib'); // amient-lib library don't support parallel using //
const Record =  require('./record.js');

var request = require('request'); // require for ambient upload //
...
// modify from ambient-lib (amient-lib library don't support parallel using)
  ...
  return {
    ...
    send: function(data, cb) {
      let options = {
        ...
        body: {writeKey: channel.writeKey, data: (data instanceof Array) ? data : [data]},
        json: true,
	timeout: ambientHttpTimeoutMilliSec // timemout //
      };
      // use request library //
